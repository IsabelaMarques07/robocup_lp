...
public class ProgramaSalasv4
{
	...
	//ESCOLHA DAS OPÇÕES DO PROGRAMA
	...
	//LEVA OS DADOS PARA O MÉTODO mostrarDialogo Salas
	//ANALISA OS DADOS OBTIDOS DA FUNÇÃO(salas escolhidas ou opção desejada pelo usuário)
	...
	//ADICIONA ; NA STRING QUE REÚNE TODAS AS LISTAS
	//CONTA A QUANTIDADE DE LISTAS
	//DETERMINA SE A LISTA ATUAL É A MAIOR ATÉ O MOMENTO
	...
	//TRANFORMA O VETOR BIDIMENSIONAL EM UM VETOR COM AS SALAS INSERIDAS DE FORMA INTERCALADA E SEM REPETIÇÃO
	//CONTA QUANTIDADE TOTAL DE SALAS
	//TRANSFORMA O VETOR DE SALAS INTERCALADAS EM UMA STRINGBUFFER
	//INSERE A STRINGBUFFER NO MÉTODO criarListaCrescente
	...
	public static void criarListaUnica() {
		...
		else 
		{
			...
			//criação do vetor bidimensional de listas
